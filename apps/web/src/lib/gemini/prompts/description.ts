...
プロジェクトタイプ: ${
		projectType === "web"
			? "Webサイト（情報発信、コーポレートサイト、ポートフォリオなど）"
			: projectType === "app"
				? "Webアプリケーション（SaaS、業務システム、ECサイトなど）"
				: "その他のWebプロジェクト"
	}
...
生成する内容の基準：
1. 機能リスト：
   - 必須機能（Must Have）：具体的で実装可能な機能を3-4個
   - 追加機能（Nice to Have）：将来的な拡張を考慮した機能を2-3個
   - 拡張機能：スケーラビリティを考慮した機能を1-2個
