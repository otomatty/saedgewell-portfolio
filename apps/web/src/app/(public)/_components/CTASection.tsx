		...
		<section className="relative py-20 overflow-hidden">
			...
			<div className="container relative mx-auto px-4">
				...
				<div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
					...
					>
						<div className="absolute -inset-1 bg-gradient-to-r from-primary to-primary-foreground rounded-2xl blur opacity-25 transition-all group-hover:opacity-40" />
						<Card className="relative h-full bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/75 transition-all duration-300 group-hover:scale-[1.02]">
					...
					>
						<Card className="bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/75 overflow-hidden">
							<CardContent className="p-8">
