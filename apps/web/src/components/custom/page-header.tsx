...
export function PageHeader({
	...
	return (
		<div
			className={cn(
				"group relative w-full overflow-hidden rounded-xl ml-8 mt-4 pr-16 border shadow-sm transition-all hover:shadow-md",
		...
		>
			<div className="container">
				...
				{/* カードの内側の影効果 */}
				<div
					className="absolute inset-[1px] rounded-xl bg-gradient-to-b from-white/10 to-white/5"
					style={patternStyle}
				/>
				...
				<div className="relative z-10 flex items-end justify-between pb-8 pt-[140px]">
					<div className="space-y-2.5">
						<h1 className="bg-gradient-to-br from-foreground to-foreground/80 bg-clip-text text-3xl font-bold tracking-tight text-transparent transition-colors group-hover:from-foreground/90 group-hover:to-foreground/70">
							{title}
						</h1>
						{description && (
